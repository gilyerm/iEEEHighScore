...
//		c11=c0^c1;c12=c0&c1;
		...
		C10.setBit(0,  !(C.getBit(0) | C.getBit(1)));
		C10.setBit(1,C.getBit(0) ^ C.getBit(1));
		C10.setBit(2,C.getBit(0) & C.getBit(1));
		...
		for (int i = 2; i < CList.size(); i++) {  // for C20-C90
			...
			for (int j = 0; j < DecaByte.SIZE; j++) {
				...
				curC.setBit(j,(a&curCDigit)|(prevC.getBit(j)&(!curCDigit)));
			}
		}
//		for (int i = 0; i < CList.size(); i++) {
//			System.out.print(i+":"+CList.get(i).toStringBin()+"\n");
//		}
//		System.out.println();
...
//		c95=(c84&c9)|(c85&(!c9));
		...
		boolean e=(!CList.get(9).getBit(5))|Y.getBit(9);
